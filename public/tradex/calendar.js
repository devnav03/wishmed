...
function validate(thisform) {
	var now1 = thisform.orderdate.value;
myOption = -1;
for (i=thisform.tempid.length-1; i > -1; i--) {
if (thisform.tempid[i].checked) {
myOption = i; i = -1;
}
}
if (myOption == -1) {
...
function DatePosition(dateString){
    ...
    if (date < today){
        alert("Date is invalid. Please supply a future date.");
        return -1;
    }else if (date > today){
        document.tempform.submit();
        //location.href = "thankyoumach/tybox.php?height=350&width=460";
        return 1;
    }else{
        alert("Date is invalid. Please supply a future date");
        return 0;
