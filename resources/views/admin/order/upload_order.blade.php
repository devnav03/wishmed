...
<div class="agile-grids">   
    <div class="grids">       
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-header">Order <a class="btn btn-sm btn-primary pull-right" href="{!! route('order.index') !!}"> <i class="fa fa-plus fa-fw"></i> All Order</a></h1>
                    ...
                    <div class="forms">
                        <div class="form-grids widget-shadow" data-example-id="basic-forms"> 
                            ...
                            <div class="form-body">
                                ...
                                {!! Form::open(array('method' => 'POST', 'route' => array('order.import'), 'id' => 'ajaxSave', 'class' => '', 'files'=>'true')) !!}
                            <div class="row">
                                <div class="col-md-5">
