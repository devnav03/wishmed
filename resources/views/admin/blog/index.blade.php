...
<div class="agile-grids">   
    <div class="grids">       
        <div class="row">
            <div class="col-md-12">                
                <h1 class="page-header">Blog List <a class="btn btn-sm btn-primary pull-right" href="{!! route('blogs.create') !!}"> <i class="fa fa-plus fa-fw"></i> Create Blog</a></h1>
                    ...
                    <div class="w3l-table-info">
                        ...
                        <form action="{{ route('blogs.action') }}" method="post">
                            ...
                            <div class="col-md-3 padding0 marginbottom10">
                                ...
                                {!! Form::text('name', null, array('class' => 'form-control live-search', 'placeholder' => 'Search blog by title')) !!}
                            </div>
