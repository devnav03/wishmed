...
<tr id="order_{{ $detail->id }}">
    ...
    <td style="vertical-align: middle;"><a href="{!! route('blogs.edit', [$detail->id]) !!}">{!! $detail->title !!}</a></td>
    <td class="text-center" style="vertical-align: middle;">
         <a href="{{ route('blogs.toggle', $detail->id) }}" title="@if($detail->status == 0) Deactive @else Active @endif ">            
