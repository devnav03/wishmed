            ...
            <div style="width:700px; min-height: 300px; margin: 0 auto; background-color:white; border: 12px solid white;">
               ...
               <div style="width: 100%; height: 100%; margin: 0 auto;">
                  <div class="header-logo" style="width: 120px; padding:20px 20px; overflow: hidden; margin: 0 auto;">
                    <a href="#" target="_blank"><img style="max-width: 150px; margin: auto; display: block;" src="{{route('home')}}/assets/frontend/images/logo.png" alt="Logo"></a>
                  </div>
                    ...
                    <table cellpadding="3" cellspacing="0" style="width: 600px; border-bottom: 1px solid #CCC; border-right: 1px solid #CCC">
                      <tbody>
                        <tr valign="top">
                          ...
                          <td style="border-top: 1px solid #CCC; border-left: 1px solid #CCC; padding: 10px; color: #3D3D3D">{{ $mail_data['first_name'] }} {{ $mail_data['last_name'] }}</td>
                        </tr>
                          <tr valign="top">
                            <td style="border-top: 1px solid #CCC; border-left: 1px solid #CCC; padding: 10px; color: #3D3D3D">Email</td>
                            <td style="border-top: 1px solid #CCC; border-left: 1px solid #CCC; padding: 10px; color: #3D3D3D">{{ $mail_data['email'] }}</td>
                          </tr>
                          <tr valign="top">
                            <td style="border-top: 1px solid #CCC; border-left: 1px solid #CCC; padding: 10px; color: #3D3D3D">Phone</td>
                            <td style="border-top: 1px solid #CCC; border-left: 1px solid #CCC; padding: 10px; color: #3D3D3D">{{ $mail_data['phone'] }}</td>
                          </tr>
                            <tr valign="top">
                              <td style="border-top: 1px solid #CCC; border-left: 1px solid #CCC; padding: 10px; color: #3D3D3D">Subject</td>
                              <td style="border-top: 1px solid #CCC; border-left: 1px solid #CCC; padding: 10px; color: #3D3D3D">{{ $mail_data['subject'] }}</td>
                            </tr>
                            <tr valign="top">
                              <td style="border-top: 1px solid #CCC; border-left: 1px solid #CCC; padding: 10px; color: #3D3D3D">Message</td>
                              <td style="border-top: 1px solid #CCC; border-left: 1px solid #CCC; padding: 10px; color: #3D3D3D"><p>{{ $mail_data['message'] }}</p>
                            </td>
                          </tr>
                        </tbody>
                      </table>
