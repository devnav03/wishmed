                    ...
                    <table class="table table-borderless mb-4">
                      <thead class="only-desktop">
                        <tr class="text-uppercase" style="background: #f47624;">
                          ...
                          <th style="border-right: 1px solid #d9d9d9; color: #fff; text-align: center;">ORDER STATUS</th>
                          <th style="border-right: 1px solid #d9d9d9; color: #fff; text-align: center;">TOTAL</th>
                          ...
                          <th style="border-right: 1px solid #d9d9d9; color: #fff; text-align: center;">ESTIMATED DELIVERY</th>
              ...
              @endphp 
                      <thead class="only-desktop">
                        <tr>
                          ...
                          <td style="border-right: 1px solid #d9d9d9;text-align: center;"><p class="mb-0">{{ $order->type }}</p></td>
                          <td style="border-right: 1px solid #d9d9d9;text-align: center;"><p class="mb-0"><i class="fa fa-inr"></i> {{ $order->total_price }}</p></td>
                          ...
                          <td style="border-right: 1px solid #d9d9d9; text-align: center;"><p class="mb-0">{{ $order->delivery_date }} ({{ $order->slot }})</p></td>
                          <td style="text-align: center;">
                            @if($order->current_status == 4)
                          <a class="btn btn-xs btn-primary" href="{{ route('enter-delivery-otp', $order->id) }}" style="background: #f47624; border-color: #f47624;"><i class="fa fa-edit"></i></a> @endif </td>
                        </tr>
                      </thead>
                      @php
                        }
